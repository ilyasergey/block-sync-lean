...
private lemma round_progression_aux
  ...
  have h_fair : SchedulerFairness system time := by
    have h := Network.belugaTrace_schedulerFairness system time h_time.1 h_scheduling
...
theorem belugaTrace_satisfies_post_gst_liveness
  ...
  have h_fair_belugaTrace : Network.SchedulerFairness_belugaTrace system time :=
    Network.belugaTrace_schedulerFairness system time h_time.1 h_scheduling
  ...
  · -- T1: store-before-advance gate at vid's first post-acceptance advance step.
    ...
    | block_store v B' =>
      ...
      · rw [h_d]; exact hB_d
    | _ => simp at hop_match
  · exact round_progression_aux system time h_time h_scheduling hHonest h_sys_nodup
  · exact round_termination_aux system hids time h_time h_scheduling hHonest h_sys_nodup
    ...
    ∀ vid_ref r k₀, isHonestValidator system vid_ref = true →
      ...
      ∃ k', k₀ ≤ k' ∧ time k' ≤ time k₀ + 3 * system.Δ ∧
        ∀ vid, isHonestValidator system vid = true →
          ∃ bv, (belugaTrace system k').getValidator vid = some bv ∧
                bv.currentRound ≥ r + 1 :=
  (belugaTrace_satisfies_post_gst_liveness system hids time h_time h_sync h_scheduling hHonest h_sys_nodup).honest_round_sync
...
theorem lemma2_round_latency
    ...
    ∀ vid r k,
      ...
      ∃ k' ≥ k, time k' ≤ time k + 3 * system.Δ ∧
        ∃ bv, (belugaTrace system k').getValidator vid = some bv ∧
              bv.currentRound = r + 1 :=
  (belugaTrace_satisfies_post_gst_liveness system hids time h_time h_sync h_scheduling hHonest h_sys_nodup).honest_round_advance
...
theorem theorem1_block_availability
  ...
  (belugaTrace_satisfies_post_gst_liveness system hids time h_time h_sync h_scheduling hHonest h_sys_nodup).block_availability
...
theorem theorem3_round_progression
  ...
  (belugaTrace_satisfies_post_gst_liveness system hids time h_time h_sync h_scheduling hHonest h_sys_nodup).round_progression
...
theorem theorem4_round_termination
  ...
  (belugaTrace_satisfies_post_gst_liveness system hids time h_time h_sync h_scheduling hHonest h_sys_nodup).round_termination
...
theorem belugaTrace_isBlockSynchronizer
  ...
  ⟨theorem3_round_progression system hids time h_time h_sync h_scheduling hHonest h_sys_nodup,
   theorem4_round_termination system hids time h_time h_sync h_scheduling hHonest h_sys_nodup,
   theorem1_block_availability system hids time h_time h_sync h_scheduling hHonest h_sys_nodup,
