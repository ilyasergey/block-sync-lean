...
| §5 — **Bundle**: `BelugaPostGSTLiveness` packaging L1, L2, T1, T3, T4 | [`Beluga/Theorems.lean :: BelugaPostGSTLiveness`](BlockSynchroniser/Beluga/Theorems.lean#L437) | ◐ Definition stated; `belugaTrace_satisfies_post_gst_liveness` has 1 sorry remaining (T4 conjunct). L1 (weakened, F-1b), L2, T1, T3 conjuncts all closed inline. Bundle now takes `hids : ValidIds system` (needed by T1's `acceptInv_trace` call). |
