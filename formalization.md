...
| §5 — **Theorem 3** — Beluga ⊨ Round-Progression | [`Beluga/Theorems.lean :: theorem3_round_progression`](BlockSynchroniser/Beluga/Theorems.lean#L610) | ◐ One-line projection of the bundle |
...
| §5 — **Bundle**: `BelugaPostGSTLiveness` packaging L1, L2, T1, T3, T4 | [`Beluga/Theorems.lean :: BelugaPostGSTLiveness`](BlockSynchroniser/Beluga/Theorems.lean#L437) | ◐ Definition stated; `belugaTrace_satisfies_post_gst_liveness` has 4 sorries (L1/T1/T3/T4 conjuncts); L2 conjunct closed inline. In flight as Aristotle round `e8212038`. |
...
| **MysticetiSafetyInv bundle** for `belugaTrace` (folds `h_admission`, `h_honest_unique`, `h_no_eq`, `h_authors_valid`) | [`Beluga/MysticetiSafetyInvariant.lean :: belugaTrace_satisfies_mysticetiSafetyInv`](BlockSynchroniser/Beluga/MysticetiSafetyInvariant.lean#L84) | ◐ 3 of 4 conjuncts sorry-free (admission via existing trace theorem; uniqueByAuthorRound + noEquivocation from `BlockInv`); `authorsValid` in flight as Aristotle round `c2ca4a2e`. |
